"""
models.py — SigmaFetcher Ultimate
"""
...
class Panel(db.Model):
    ...
    panel_type   = db.Column(db.String(16),  default="ints")
...
class Order(db.Model):
    ...
    def to_dict(self):
        ...
        return dict(id=self.id, status=self.status,
                    ...
                    messages=[m.to_dict() for m in vn.messages
                              .order_by(SMSMessage.received_at.desc()).limit(20)] if vn else [])
